...
function getAlcohol_success(tx, results){
	...
	for (var i=0; i<len; i++){
		...
		//alert('before append');
		$('#champagneList').append('<li><a href="location.html?name=' + alcohol.cName + '&category=champagne"><p>' + alcohol.cName + '</p></li>');
...
function populateDB(tx) {
	 tx.executeSql('CREATE TABLE IF NOT EXISTS COCKTAIL (id integer primary key, cName varchar(50), cCategory varchar(50), cImg varchar(50), cLongtitude varchar(50), cLatitude varchar(50))');
	 dbCreated = true;
}
